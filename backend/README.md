...
## Project Structure
    ...
    ├── universalrythem_32223  # Django project configurations
...
1. Clone this repo and `cd universalrythem_32223`
...
2. Clone this repo and `cd universalrythem_32223`
